...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        Button _19_BroadcastReceiverBtn = findViewById(R.id._19_BroadcastReceiverBtn);

        _19_BroadcastReceiverBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent();
                ComponentName cname = new ComponentName("com.example.androidlectureexample",
                        "com.example.androidlectureexample.Example19_BroadcastReceiverActivity");
                i.setComponent(cname);
                startActivity(i);
            }
        });
        ...
        Button _21_BRNotiBtn = findViewById(R.id._21_BRNotiBtn);
        
        _21_BRNotiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent();
                ComponentName cname = new ComponentName("com.example.androidlectureexample",
                        "com.example.androidlectureexample.Example21_BRNotiActivity");
                i.setComponent(cname);
                startActivity(i);
            }
        });

        Button _22_SQLiteBasicBtn = findViewById(R.id._22_SQLiteBasicBtn);

        _22_SQLiteBasicBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent();
                ComponentName cname = new ComponentName("com.example.androidlectureexample",
                        "com.example.androidlectureexample.Example22_SQLiteBasicActivity");
                i.setComponent(cname);
                startActivity(i);
            }
        });
        ...
        Button _24_ContentProviderBtn = findViewById(R.id._24_ContentProviderBtn);

        _24_ContentProviderBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent();
                ComponentName cname = new ComponentName("com.example.androidlectureexample",
                        "com.example.androidlectureexample.Example24_ContentProviderActivity");
                i.setComponent(cname);
                startActivity(i);
            }
        });
        ...
        Button lightControlBtn = findViewById(R.id.lightControlBtn);
        ...
        lightControlBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent();
                ComponentName cname = new ComponentName("com.example.androidlectureexample",
                        "com.example.androidlectureexample.lightControlActivity");
                i.setComponent(cname);
                startActivity(i);
            }
        });
